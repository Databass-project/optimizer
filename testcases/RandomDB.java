...
public class RandomDB {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //TODO added this one to prevent infinite loop
            if (pk.length < numtuple) {
                System.out.println("You must set the range of primary key to be greater or equal to the number of tuples");
                System.exit(1);
            }
...
//                System.out.println("in table generation: "+i);
                ...
                while (pk[numb]) {
                    ...
                    // bug: halts here after 199 iterations
                }
                pk[numb] = true;
                outtbl.print(numb + "\t");
